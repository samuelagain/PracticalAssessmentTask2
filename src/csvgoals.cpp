...
//Fucntion to read from a csv file into a 2D Vector, Each vector is <x,y>
...
//Fucntion to overwrite the coordinates.csv file with the coordinates and their outcome
